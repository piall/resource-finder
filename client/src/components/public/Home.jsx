    ...
    <PublicLayout>
      ...
      <section id="About" className={styles.section}>
        ...
        <p>
          ...
          search engine. But search engine has not made for learning purpose.
          This platform tries to solve this problem. Anyone can share any
          resources other can vote those for learning level by doing that each
          one helps each other to know which topic is for which learning level
        </p>
      </section>
